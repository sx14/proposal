...
function [recall, smT_IoU,flow_time,flow2_time,time_cost,frame_sum] = run(video_package_path,video_dir,annotation_package_path,mid_result_path,output_path,re_cal)
