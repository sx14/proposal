...
% run(base_path,package_dir,'/ILSVRC2015_train_00001001',[annotation_path,'/ILSVRC2015_train_00001001'],output_path);   % 乌龟2 bad | 太难
...
dataset_path = '/home/sunx/dataset/ImageNet/train/chosen1';
...
% run([dataset_path,'/ILSVRC2015_train_00150006'],[annotation_path,'/ILSVRC2015_train_00150006'],'JPEG','hier',true);   % 一堆鸟 find all | not good
