...
for i = 1:9
    ...
    I = imread(fullfile(mcg_root, 'demos2','video',img_name_1));
    show.image = I;
    hier_name = [num1,'.mat'];
    curr_hier = load(fullfile(mcg_root, 'demos2','hier',hier_name));
    curr_hier  = curr_hier.hier;
    if i == 1
        [net,last_hier] = grow_lines(i, net, I, curr_flow, curr_hier);
        last_flow = curr_flow;
    else
        curr_flow2 = load(fullfile(mcg_root, 'demos2','flow2',flow_name));
