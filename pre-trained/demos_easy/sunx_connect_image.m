...
imgs = dir(fullfile(mcg_root, 'demos_easy_easy','video','*.jpg'));
...
for i = start_frame:end_frame
    ...
    I = imread(fullfile(mcg_root, 'demos_easy','video',img_name_1));
    show.image = I;
    hier_name = [num1,'.mat'];
    curr_hier = load(fullfile(mcg_root, 'demos_easy','hier',hier_name));
