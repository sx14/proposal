function scores = get_motion_scores(all_cand_sps,sp_flow_sum,sp_boundary_connectivity)
%     avg_overall_flow = get_camera_motion(sp_flow_sum,sp_boundary_connectivity);
...
function camera_motion = get_camera_motion(sp_flow_sum,sp_boundary_connectivity)
    % cal camera motion with background area flow
end