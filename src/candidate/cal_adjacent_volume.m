...
temporal_intersection_ratio(temporal_intersection_ratio < temporal_intersection_ratio_ths) = 0; % 共现时间小于阈值的
space_temporal_adjacent_ratio = space_adjacent_length ./ temporal_intersection_length;          % 空间上相邻的帧数 / 时间上相交的帧数
space_temporal_adjacent_ratio(space_temporal_adjacent_ratio < space_temporal_adjacent_ratio_ths) = 0;   % 空间相邻次数小于阈值的
